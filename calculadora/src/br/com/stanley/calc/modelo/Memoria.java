package br.com.stanley.calc.modelo;
...
public class Memoria {
    ...
    private enum TipoComando{
        ZERAR, NUMERO, DIV, MULT, SUB, SOMA, IGUAL, VIRGULA, NEGPOS
    }
    ...
    public void processarComando(String texto) {
        ...
        if(tipoComando == null){
            ...
            substituir = false;
        } else if (tipoComando == TipoComando.NEGPOS) {
            textoAtual = negativoPositivo();
            substituir = false;
        }
        else {
            substituir = true;
    ...
    private String negativoPositivo() {
        if(textoAtual.isEmpty() || textoAtual == "0"){
            ...
            String resultadoString = Double.toString(numeroAtual)
                    .replace(".", ",");
